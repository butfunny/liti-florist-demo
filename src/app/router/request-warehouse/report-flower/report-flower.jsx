                    ...
                    <div className="card">
                        <div className="card-title">
                            <i className="fa fa-chevron-left text-primary"
                               ...
                               aria-hidden="true"/> Báo cáo hao hụt / hủy hỏng
                        </div>
                        ...
                        <div className="card-body">
                            ...
                            <div className="row">
                                ...
                                <Select
                                    className="col"
                                    label="Loại báo cáo"
                                    list={reportTypes.map(s => s.value)}
                                    value={request.requestType}
                                    displayAs={(r) => reportTypes.find(s => s.value == r).label}
                                    onChange={(requestType) => this.setState({request: {...request, requestType}})}
                                />
                            </div>
