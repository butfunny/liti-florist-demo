            ...
            <div>
                ...
                <div className="row" style={{marginTop: "10px", fontSize: "12px"}}>
                    ...
                    <div className="col-md-3 col-xs-3">
                        SHIP:
                        <br/>
                        {bill.ships && <b>{bill.ships.map(f => f.username).join(", ")} {bill.ships && bill.ships.length > 0 && bill.ships[0].shipType != undefined ? `(${shipTypes.find(s => s.value == bill.ships[0].shipType).label})` : ""}</b>}
                    </div>
                    <div className="col-md-3 col-xs-3">
                        SALE:
                        <br/>
